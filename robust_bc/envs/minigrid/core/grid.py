...
from envs.minigrid.core.constants import OBJECT_TO_IDX, TILE_PIXELS
from envs.minigrid.core.world_object import Wall, WorldObj
from envs.minigrid.utils.rendering import (
    downsample,
    fill_coords,
    highlight_img,
    point_in_rect,
