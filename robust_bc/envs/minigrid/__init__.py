...
from envs.minigrid import minigrid_env, wrappers
from envs.minigrid.core import roomgrid
from envs.minigrid.core.world_object import Wall
from envs.minigrid.envs.wfc.config import WFC_PRESETS, register_wfc_presets
...
def register_minigrid_envs():
    ...
    register(
        ...
        entry_point="envs.minigrid.envs:BlockedUnlockPickupEnv",
    )
    ...
    register(
        ...
        entry_point="envs.minigrid.envs:CrossingEnv",
    ...
    register(
        ...
        entry_point="envs.minigrid.envs:DistShiftEnv",
        kwargs={"strip2_row": 2},
    )
    ...
    register(
        ...
        entry_point="envs.minigrid.envs:DoorKeyEnv",
        kwargs={"size": 5},
    )
    ...
    register(
        ...
        entry_point="envs.minigrid.envs:DynamicObstaclesEnv",
    ...
    register(
        ...
        entry_point="envs.minigrid.envs:EmptyEnv",
        kwargs={"size": 5},
    )
    ...
    register(
        ...
        entry_point="envs.minigrid.envs:FetchEnv",
    ...
    register(id="MiniGrid-Fetch-8x8-N3-v0", entry_point="envs.minigrid.envs:FetchEnv")
    ...
    register(
        ...
        entry_point="envs.minigrid.envs:FourRoomsEnv",
    )
    ...
    register(
        ...
        entry_point="envs.minigrid.envs:GoToDoorEnv",
    )
    ...
    register(
        ...
        entry_point="envs.minigrid.envs:GoToObjectEnv",
    )
    ...
    register(
        ...
        entry_point="envs.minigrid.envs:KeyCorridorEnv",
    ...
    register(
        ...
        entry_point="envs.minigrid.envs:LavaGapEnv",
        kwargs={"size": 5},
    )
    ...
    register(
        ...
        entry_point="envs.minigrid.envs:LockedRoomEnv",
    )
    ...
    register(
        ...
        entry_point="envs.minigrid.envs:MemoryEnv",
    ...
    register(
        ...
        entry_point="envs.minigrid.envs:MultiRoomEnv",
    ...
    register(
        ...
        entry_point="envs.minigrid.envs:ObstructedMaze_1Dlhb",
    ...
    register(
        ...
        entry_point="envs.minigrid.envs:ObstructedMaze_Full",
        kwargs={
            "agent_room": (2, 1),
            "key_in_box": False,
            "blocked": False,
    ...
    register(
        ...
        entry_point="envs.minigrid.envs:ObstructedMaze_Full_V1",
        kwargs={
            "agent_room": (2, 1),
            "key_in_box": True,
            "blocked": True,
    ...
    register(
        ...
        entry_point="envs.minigrid.envs:PlaygroundEnv",
    )
    ...
    register(
        ...
        entry_point="envs.minigrid.envs:PutNearEnv",
    )
    ...
    register(
        ...
        entry_point="envs.minigrid.envs:RedBlueDoorEnv",
        kwargs={"size": 6},
    )
    ...
    register(id="MiniGrid-Unlock-v0", entry_point="envs.minigrid.envs:UnlockEnv")
    ...
    register(
        ...
        entry_point="envs.minigrid.envs:UnlockPickupEnv",
    )
    ...
    register(
        ...
        entry_point="envs.minigrid.envs.babyai:GoToRedBallGrey",
    )

    register(
        id="BabyAI-GoToRedBall-v0",
        entry_point="envs.minigrid.envs.babyai:GoToRedBall",
    )

    register(
        id="BabyAI-GoToRedBallNoDists-v0",
        entry_point="envs.minigrid.envs.babyai:GoToRedBallNoDists",
    )

    register(
        id="BabyAI-GoToObj-v0",
        entry_point="envs.minigrid.envs.babyai:GoToObj",
    )
    ...
    register(
        ...
        entry_point="envs.minigrid.envs.babyai:GoToLocal",
    )
    ...
    register(
        id="BabyAI-GoTo-v0",
        entry_point="envs.minigrid.envs.babyai:GoTo",
    )
    ...
    register(
        ...
        entry_point="envs.minigrid.envs.babyai:GoToImpUnlock",
    )

    register(
        id="BabyAI-GoToSeq-v0",
        entry_point="envs.minigrid.envs.babyai:GoToSeq",
    )
    ...
    register(
        ...
        entry_point="envs.minigrid.envs.babyai:GoToRedBlueBall",
    )

    register(
        id="BabyAI-GoToDoor-v0",
        entry_point="envs.minigrid.envs.babyai:GoToDoor",
    )

    register(
        id="BabyAI-GoToObjDoor-v0",
        entry_point="envs.minigrid.envs.babyai:GoToObjDoor",
    )
    ...
    register(
        id="BabyAI-Open-v0",
        entry_point="envs.minigrid.envs.babyai:Open",
    )

    register(
        id="BabyAI-OpenRedDoor-v0",
        entry_point="envs.minigrid.envs.babyai:OpenRedDoor",
    )

    register(
        id="BabyAI-OpenDoor-v0",
        entry_point="envs.minigrid.envs.babyai:OpenDoor",
    )
    ...
    register(
        ...
        entry_point="envs.minigrid.envs.babyai:OpenTwoDoors",
    )
    ...
    register(
        ...
        entry_point="envs.minigrid.envs.babyai:OpenDoorsOrder",
        kwargs={"num_doors": 2},
    )
    ...
    register(
        id="BabyAI-Pickup-v0",
        entry_point="envs.minigrid.envs.babyai:Pickup",
    )

    register(
        id="BabyAI-UnblockPickup-v0",
        entry_point="envs.minigrid.envs.babyai:UnblockPickup",
    )

    register(
        id="BabyAI-PickupLoc-v0",
        entry_point="envs.minigrid.envs.babyai:PickupLoc",
    )

    register(
        id="BabyAI-PickupDist-v0",
        entry_point="envs.minigrid.envs.babyai:PickupDist",
    )
    ...
    register(
        ...
        entry_point="envs.minigrid.envs.babyai:PickupAbove",
    )
    ...
    register(
        ...
        entry_point="envs.minigrid.envs.babyai:PutNextLocal",
    )
    ...
    register(
        ...
        entry_point="envs.minigrid.envs.babyai:PutNext",
    ...
    register(
        id="BabyAI-Unlock-v0",
        entry_point="envs.minigrid.envs.babyai:Unlock",
    )

    register(
        id="BabyAI-UnlockLocal-v0",
        entry_point="envs.minigrid.envs.babyai:UnlockLocal",
    )
    ...
    register(
        ...
        entry_point="envs.minigrid.envs.babyai:KeyInBox",
    )

    register(
        id="BabyAI-UnlockPickup-v0",
        entry_point="envs.minigrid.envs.babyai:UnlockPickup",
    )
    ...
    register(
        ...
        entry_point="envs.minigrid.envs.babyai:BlockedUnlockPickup",
    )

    register(
        id="BabyAI-UnlockToUnlock-v0",
        entry_point="envs.minigrid.envs.babyai:UnlockToUnlock",
    )
    ...
    register(
        ...
        entry_point="envs.minigrid.envs.babyai:ActionObjDoor",
    )

    register(
        id="BabyAI-FindObjS5-v0",
        entry_point="envs.minigrid.envs.babyai:FindObjS5",
    )
    ...
    register(
        ...
        entry_point="envs.minigrid.envs.babyai:KeyCorridor",
    )
    ...
    register(
        ...
        entry_point="envs.minigrid.envs.babyai:OneRoomS8",
    )
    ...
    register(
        ...
        entry_point="envs.minigrid.envs.babyai:MoveTwoAcross",
        kwargs={"room_size": 5, "objs_per_room": 2},
    )
    ...
    register(
        id="BabyAI-Synth-v0",
        entry_point="envs.minigrid.envs.babyai:Synth",
    )
    ...
    register(
        ...
        entry_point="envs.minigrid.envs.babyai:SynthLoc",
    )

    register(
        id="BabyAI-SynthSeq-v0",
        entry_point="envs.minigrid.envs.babyai:SynthSeq",
    )

    register(
        id="BabyAI-MiniBossLevel-v0",
        entry_point="envs.minigrid.envs.babyai:MiniBossLevel",
    )

    register(
        id="BabyAI-BossLevel-v0",
        entry_point="envs.minigrid.envs.babyai:BossLevel",
    )

    register(
        id="BabyAI-BossLevelNoUnlock-v0",
        entry_point="envs.minigrid.envs.babyai:BossLevelNoUnlock",
    )
