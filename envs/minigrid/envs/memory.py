...
class MemoryEnv(MiniGridEnv):
    ...
    def _gen_grid(self, width, height):
        ...
        self.agent_pos = np.array((6, height // 2))
        self.agent_dir = 3
        ...
        self.grid.set(
            self._rand_int(1, 4),
            self._rand_elem([height // 2 - 1, height // 2 + 1]),
            start_room_obj("green"),
        )
